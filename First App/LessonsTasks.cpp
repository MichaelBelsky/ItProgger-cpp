...
void Lesson29() {/*
	Создайте класс, в котором реализуйте
	чистую виртуальную функцию для конструктора.

	Создайте второй класс и сделайте его дочерним к первому классу.
	Реализуйте во втором классе конструктор.*/
